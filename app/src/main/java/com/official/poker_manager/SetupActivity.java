...
public class SetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seatsMap.put(0, findViewById(R.id.seat_0));
        seatsMap.put(1, findViewById(R.id.seat_1));
        seatsMap.put(2, findViewById(R.id.seat_2));
        seatsMap.put(3, findViewById(R.id.seat_3));
        seatsMap.put(4, findViewById(R.id.seat_4));
        seatsMap.put(5, findViewById(R.id.seat_5));
        seatsMap.put(6, findViewById(R.id.seat_6));
        seatsMap.put(7, findViewById(R.id.seat_7));
        seatsMap.put(8, findViewById(R.id.seat_8));
        seatsMap.put(9, findViewById(R.id.seat_9));
